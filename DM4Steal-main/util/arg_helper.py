...
from util.data_generators import load_dataset
from util.graph_utils import pad_adjs
from util.loading_utils import get_score_model
...
def parse_arguments(default_config="train.yaml"):
    ...
    parser.add_argument(
        ...
        '--config_file',
        type=str,
        default='config/train_ego_small.yaml',
