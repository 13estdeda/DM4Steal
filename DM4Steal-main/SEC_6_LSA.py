...
def main():
    ...
    sample_adj,sample_features,sample_list=sample_with_shadow(adj,embed.cpu().detach(),adj_shadow,embed_shadow.cpu().detach(),96)
    ...
    sample_adj_test, sample_features_test = sample_infer(adj, embed.cpu().detach(),adj_infer.cpu().detach(),embed_shadow.cpu().detach(), 96)
    sample_adj_test=sample_adj_test.type(torch.float32)
