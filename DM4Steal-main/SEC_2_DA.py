...
def main():
    ...
    sample_adj,sample_features,sample_list=sample(adj,features.cpu().detach(),args.batch,args.maxsize,args.minsize)
    ...
    sample_adj_test, sample_features_test = sample_infer(adj, features.cpu().detach(),inference_adj, args.batch,args.maxsize,args.minsize)
    sample_adj_test=sample_adj_test.type(torch.float32)
